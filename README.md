...
The model training is done on a dataset containing 36 classes,which are 'A'-'Z' and 0-9 using a CNN model architecture with softmax activation fucntion.Later,the model prediction is compared with the
